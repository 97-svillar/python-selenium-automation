...
Feature: Tests for Target Sign-in
  ...
  Scenario: User gets error message after signing in with incorrect password
    Given Open sign in page
    When enter 97svillar@gmail.com and select continue
    And enter 123456789 and selects continue
